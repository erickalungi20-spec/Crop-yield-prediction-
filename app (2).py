...
def api_advisory():
    ...
    Body: { district, crop_key, area_acres, purpose, planting_date, phone? }
    planting_date: "YYYY-MM-DD" or omitted/"" for "planted today".
    phone: optional — if given and that phone has a recent ESP32 sensor
    reading, it's used the same way the USSD flow uses it.
    """
